							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									...
									<span class="submit-btn">
										...
										<button type="submit" class="button-secondary h-100">Choose</button>
									</span>
															...
															<div class="customlinkdiv" id="customlinkdiv">
																<p id="menu-item-url-wrap">
																	<label class="howto" for="custom-menu-item-url"> <span>URL</span>&nbsp;&nbsp;&nbsp;
																		<input id="custom-menu-item-url" name="url" type="text" class="menu-item-textbox " placeholder="https://">
																	</label>
																</p>
											...
											<div class="menu-edit ">
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
																Please select a menu which you want to edit and click "choose" button.
															</p>
														</div>
														@endif
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<a class="item-delete submitdelete deletion text-danger" id="delete-{{$m->id}}" href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Delete</a>
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a class="item-cancel button-secondary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Cancel</a>
																		<!-- <span class="meta-sep hide-if-no-js"> | </span> -->
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														@if(request()->has('action'))
														<div class="publishing-action py-3">
															<!-- <a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="button button-primary menu-save">Create menu</a> -->
														</div>
														@elseif(request()->has("menu"))
